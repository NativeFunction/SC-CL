...
extern __unsafeIntrinsic void __callNative(const uint paramCount, const uint returnCount, const uint nativeHash);
extern __unsafeIntrinsic void __callNativePC(const uint paramCount, const uint returnCount, const uint nativeHash64Part1, const uint nativeHash64Part2);
